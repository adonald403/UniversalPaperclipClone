...
function buyWire(){
    if(funds >= wireCost){
        wirePriceTimer = 0;
        wire = Math.floor(wire + Math.pow(wireSupply, wirePurchase/100));
...
function makeClipper(){  
    if(funds >= clippperCost){
        clipmakerLevel = clipmakerLevel + 100;
...
function makeMegaClipper(){  
    if(funds >= megaClipperCost){
        megaClipperLevel = megaClipperLevel + 100;
...
function buyAds(){
    if(funds >= adCost){
        ...
        funds = funds - adCost; 
        adCost = Math.floor(adCost * 1.1);
        clipperBoost = Math.floor(clipperBoost * 2);
        megaClipperBoost = Math.floor(megaClipperBoost * 5);
...
function raisePrice(){
    margin = (Math.round((margin + 1)*100))/100;  
...
function cheatClips(){
    clips = clips + 1000000000000000000000000000000000000000000000000000;
    unusedClips = unusedClips + 1000000000000000000000000000000000000000000000000000;
    displayMessage("you just cheated");
    }

function cheatMoney(){
    funds = funds + 1000000000000000000000000000000000000000000000000000;
    document.getElementById("funds").innerHTML = funds.toFixed(2);
...
function spawnProbes(){
    var nextGen = Math.floor(Math.pow((probeCount * probeRepBaseRate), probeRep));
